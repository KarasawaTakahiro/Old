...
SAVEFILE = u'watcher.nco'
SAVEDIR = os.getcwd()


class _SelectExePanel(wx.Panel):
    """
...
class _SelectMoviePanel(wx.Panel):
    """
...
class MainWin(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.FORMATS = formats.WatcherFormats(filedir=SAVEDIR, filename=SAVEFILE)
        self.FORMATS.load()
