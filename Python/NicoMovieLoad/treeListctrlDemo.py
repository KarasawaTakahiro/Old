...
class TestPanel(wx.Panel):
    def __init__(self, parent, log):
        ...
        for x in range(15):
            txt = "Item %d" % x
            child = self.tree.AppendItem(self.root, txt)  # tree part
            self.tree.SetItemText(child, txt + "(c1)", 1)  # description 1
            self.tree.SetItemText(child, txt + "(c2)", 2)  # description 2
